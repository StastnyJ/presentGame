...
const Basketball = (sendMessage: (topic: string, msg: string) => void) => [
  ...
  <TextScene text="Kromě znalostí ze školy je potřeba si osvojit nějakou sportovní dovednost. Tvým aktuálním úkolem bude naučit se, jak se hraje basketball. Tvůj úkol je jednoduchý, dej 3 koše a prokaž se jako schopný velký basketballista." />,
