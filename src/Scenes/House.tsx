...
const House = (sendMessage: (topic: string, msg: string) => void) => [
  ...
  <TextScene text="Nyní je potřeba zajistit vlastní místo na bydlení. Tvůj úkol bude postavit dům. Jednoduše vyplň cihlami vžechna místa, která jsou podle obrázku potřeba vyplnit (můžeš dávat cihle i mimo, důležité je jen to, aby jsi vyplnil celý dům)" />,
